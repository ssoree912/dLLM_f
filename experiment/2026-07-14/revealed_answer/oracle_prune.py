...
def make_oracle_attention(
    ...
    def wrapped_attention(
        ...
        if attention_bias is not None or layer_past is not None or use_cache or block_mask is not None:
        ...
        output = oracle_pruned_attention(block_self, q, k, v, controller)
        return output, None
